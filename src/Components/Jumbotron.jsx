           ...
           <div className="overlay md:backdrop-blur-sm w-full">
            <div className="flex justify-center align-middle flex-col gap-10 z-10">
                  ...
                  <div className='w-full'>
                      ...
                      <div class="relative mt-1 rounded-md shadow-sm md:w-[80%] w-[96%]  md:mx-auto flex flex-row gap-4 md:justify-center justify-start ml-[-110px] ">
                        <div class="pointer-events-none absolute inset-y-0 md:left-0 md:right-[100%]  flex items-center pl-3">
                           <span class=" sm:text-6xl "><BsSearch className='md:text-2xl text-3xl my-auto '/></span> 
                        </div>
                        <input type="text" name="price" id="price" class=" block md:w-full rounded-md w-[250px] border-gray-300 md:h-14 px-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm text-3xl h-12 " />
